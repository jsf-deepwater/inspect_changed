...
public class AlertController {
    ...
    public AlertController(Context context, DialogInterface di, Window window, int gravity) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
        mHandler = new ButtonHandler(di);
        mAlertDialogLayout = R.layout.dialog_base;
        mGravity = gravity;
    }
    ...
    /**
     * @see android.app.AlertDialog.Builder#setCustomTitle(android.view.View)
     */
...
//            mWindow.findViewById(R.id.parentPanel).setBackgroundColor(0xffffffff);
    ...
    private boolean setupButtons() {
        int whichButtons = 0;
        mButtonPositive = (Button) mWindow.findViewById(R.id.bt_positive);
        ...
        mButtonNegative = (Button) mWindow.findViewById(R.id.bt_negative);
        ...
        mButtonNeutral = (Button) mWindow.findViewById(R.id.bt_natural);
...
/*
    ...
    /*private void centerButton(TextView button) {
        ...
        //background is null when button
        button.setBackgroundResource(R.drawable.monitor_normal_btn_halfcircle_bg);
    }*/
        ...
        if (mTransplantBg) {
            ...
            for (pos = 0; pos < views.length; pos++) {
                ...
                if (lastView != null) {
                    if (!setView) {
                        ...
                        lastView.setBackgroundColor(lastLight ? topBright : topDark);
                    } else {
                        //lastView.setBackgroundResource(lastLight ? centerBright : centerDark);
                        lastView.setBackgroundColor(lastLight ? centerBright : centerDark);
                    }
                    setView = true;
                }
                lastView = v;
            ...
            if (lastView != null) {
                if (setView) {
                     ...
                     */
                    lastView.setBackgroundColor(
                            lastLight ? (hasButtons ? bottomMedium : bottomBright) : bottomDark);
                } else {
                    lastView.setBackgroundColor(lastLight ? fullBright : fullDark);
                }
            }
        }
    ...
    public static class AlertParams {
        ...
        public AlertDialog.DismissCallBack mDismissCallBack;
